...
Figure `r Zhist` shows the distribution of the predator prey body mass ratios for the adult fish species that persist in our simulations. This distribution is similar to the initial log normal random distribution that we assigned the species. This shows that extinctions occur relatively randomly with respect to allometric ratio. allometric ratio does not have a large effect on whether the species will persist
