...
z=z+1;LH_Mclump=z
cap=paste("Figure",LH_Mclump,"The final biomass and CV of ")
```

Figure `r LH_Mclump` shows the fish and total ecosystem biomass as a function of the asymptotic body mass of the largest fish species. It also shows the CV of the fish and total biomass after the ecosystem has stabilized. 
