...
cap=paste("Figure","Boxplot of the percent of extant nodes in each experiment.")
```
...
cap=paste("Figure","Boxplot of the number of extant species in each experiment.")
```
...
cap=paste("Figure","Boxplot of the number of extant fish in each experiment.")
```
...
cap=paste("Figure","The von-Bertalanffy curve displaying the growth of three different fish species in the same food web simulation")
```
...
cap=paste("Figure","Von-Bertalanffy curves for extant fish in several simulated food webs. Each colour represents a different food web.")
```
...
cap=paste("Figure","The von-Bertalanffy plots for the extant fish species in nine different simulations.")
```
...
cap=paste("Figure","A histogram of the allometric ratios for all the extant adult fish life stages.")
```
