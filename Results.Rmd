...
z=z+1;TSsolo=z
cap=paste("Figure",TSsolo,"A typical time series for experiment 1. This shows the Biomass of each fish life stage along with the combined biomass of the rest of the ecosystem.")
```

A typical time series of the logged biomass for a stable population is shown in figure `r TSsolo`. 
