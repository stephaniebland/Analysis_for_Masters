...
cap=paste("Figure","The mean percent of extant nodes in each experiment. The error bars are of 2 times the standard error.")
```
...
cap=paste("Figure","The mean number of extant fish in each experiment. The error bars are of 2 times the standard error.")
```
